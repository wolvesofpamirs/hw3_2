...
def newModel2():
    ...
    x = Convolution2D(128, (7, 7),padding='same', strides=(2, 2), kernel_initializer='glorot_uniform', data_format = "channels_first")(input_img)
    x = MaxPooling2D((2, 2 ), dim_ordering="th")(x)#, dim_ordering="th"
    s = Convolution2D(16, (1, 1),padding='same', kernel_initializer='glorot_uniform', data_format = "channels_first")(x)
    f1 = Convolution2D(64, (1, 1),padding='same', kernel_initializer='glorot_uniform', data_format = "channels_first")(s)
    f2 = Convolution2D(64, (3, 3),padding='same', kernel_initializer='glorot_uniform', data_format = "channels_first")(s)
    ...
    '''
    x = Convolution2D(32, (5, 5),padding='same', kernel_initializer='glorot_uniform', data_format = "channels_first")(merge2)
    s = Convolution2D(16, (1, 1),padding='same', kernel_initializer='glorot_uniform', data_format = "channels_first")(x)
    f1 = Convolution2D(64, (1, 1),padding='same', kernel_initializer='glorot_uniform', data_format = "channels_first")(s)
    f2 = Convolution2D(64, (3, 3),padding='same', kernel_initializer='glorot_uniform', data_format = "channels_first")(s)
    merge2 = Concatenate(axis=1)([f1, f2])
